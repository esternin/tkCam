...
package require Tk
puts [package require tcluvc];	# this is ONLY available in undroidwish/vanillawish
...
proc findCameras {} {
  ...
  if ($::DEBUG) {puts stderr "DEBUG: uvc_list is \"$uvc_list\""}
  set l 0
  ...
  if ($::DEBUG) {puts stderr "DEBUG: DeviceMap is \"$DeviceMap\""}
